...
- **Mathematical Preset Limiting** — Presets support "Floor" (minimum) and "Ceiling" (maximum) modes, allowing for nuanced automation that reacts to the current baseline.
